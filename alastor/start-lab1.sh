...
# GT
bash start-log.sh --n_benign 0 --n_attack 1 --total_time 2 --data_attack_type escape --rename gt
# RC1, 1req/sec
bash start-log.sh --n_benign 1 --n_attack 1 --total_time 2 --data_attack_type escape --rename rc1
# RC2, 10req/sec
bash start-log.sh --n_benign 18 --n_attack 1 --total_time 2 --data_attack_type escape --rename rc2
# RC3, 50req/sec
bash start-log.sh --n_benign 49 --n_attack 1 --total_time 1 --data_attack_type escape --rename rc3
