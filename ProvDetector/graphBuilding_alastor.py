...
def graphBuilding_alastor(path_list):
    G = []
    for i in path_list:
        ...
        for line in line_now:  # srcId srcType dstId dstType edgeType timestamp
            ...
            G_now.out_edges[G_now.nodeId_map[line[0]]].append(G_now.edge_cnt) #？记录这是日志里的第几条边吗
            G_now.in_edges[G_now.nodeId_map[line[2]]].append(G_now.edge_cnt) #？记录这是日志里的第几条边吗
