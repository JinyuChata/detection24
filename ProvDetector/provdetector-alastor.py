...
from graphBuilding_alastor import graphBuilding_alastor
from Graph import *
...
attack_list = [
            './split_test_alastor/modify-rc3-20241018070359_1.txt',
            './split_test_alastor/cfattack-rc3-20241017170216_1.txt',
            './split_test_alastor/warm-rc3-20241018070516_1.txt',
            './split_test_alastor/escape-rc3-20241017170302_1.txt',
            './split_test_alastor/leak-rc3-20241018070436_1.txt',
            './split_test_alastor/modify-rc3-20241018070359_2.txt',
            './split_test_alastor/cfattack-rc3-20241017170216_2.txt',
            './split_test_alastor/warm-rc3-20241018070516_2.txt',
            './split_test_alastor/escape-rc3-20241017170302_2.txt',
            './split_test_alastor/leak-rc3-20241018070436_2.txt',
            ]
...
def detect(train_path_list: list, test_path_list: list):
    ...
    G = graphBuilding_alastor(train_path_list + test_path_list)  # 构建数据源图
...
def run_method_folder():
    folder_1 = './split_train_alastor'
    folder_2 = './split_test_alastor'
    train_data_list = [os.path.join(folder_1, f) for f in os.listdir(folder_1) if f.endswith('.txt') and 'rc3' in f]
    test_data_list = [os.path.join(folder_2, f) for f in os.listdir(folder_2) if f.endswith('.txt') and 'rc3' in f]
